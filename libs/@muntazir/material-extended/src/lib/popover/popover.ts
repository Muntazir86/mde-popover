...
export class MdePopover implements MdePopoverPanel, OnDestroy {
    ...
    this.popoverArrowStyles = {
      ...
      top:
        this.positionY === 'center'
          ? `calc(50% - ${this.arrowOffsetY + this.arrowWidth}px)`
          : '',
      'border-top':
        this.positionY === 'center'
      ...
      'border-right':
        this.positionY === 'center' && this.positionX === 'after'
          ? this.arrowWidth + 'px solid ' + this.arrowColor
          : this.arrowWidth + 'px solid transparent',
      'border-bottom':
        this.positionY === 'above'
          ...
          : this.arrowWidth + 'px solid transparent',
      'border-left':
        this.positionY === 'center' && this.positionX === 'before'
          ? this.arrowWidth + 'px solid ' + this.arrowColor
          : this.arrowWidth + 'px solid transparent',
    };
  ...
  setPositionClasses(posX = this.positionX, posY = this.positionY): void {
    ...
    this._classList['mde-popover-center'] =
  ...
  getArrowLeftStyle() {
    if (
      ...
      (this.positionY === 'above' || this.positionY === 'below')
    ) {
